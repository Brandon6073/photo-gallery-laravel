...
<x-card class="p-10 max-w-lg mx-auto mt-24">
    <header class="text-center">
        ...
        <p class="mb-4 text-text1">Create an account</p>
    </header>

    <form method="POST" action="/users">
        @csrf
        <div class="mb-6">
            <label for="name" class="inline-block text-lg mb-2 text-text1">
                Name
            </label>
            <input
                type="text"
        ...
        <div class="mt-8">
            <p class="text-text1">
                ...
                <a href="{{route('users.login')}}" class="text-blue-500 hover:text-blue-400"
                    >Login</a
                >
            </p>
        </div>
